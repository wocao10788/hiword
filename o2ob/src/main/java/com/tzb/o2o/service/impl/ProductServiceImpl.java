...
import com.tzb.o2o.dao.ProductDao;
import com.tzb.o2o.dao.ProductImgDao;
import com.tzb.o2o.dto.ImageHolder;
import com.tzb.o2o.dto.ProductExecution;
import com.tzb.o2o.entity.Product;
import com.tzb.o2o.entity.ProductImg;
import com.tzb.o2o.enums.ProductStateEnum;
import com.tzb.o2o.exceptions.ProductOperationException;
import com.tzb.o2o.service.ProductService;
import com.tzb.o2o.util.ImageUtil;
import com.tzb.o2o.util.PageCalculatorUtil;
...
public class ProductServiceImpl implements ProductService {
     ...
     * 2.向 tb_product 写入商品信息，获取productId
    ...
    public ProductExecution modifyProduct(Product product, ImageHolder thumbnail, List<ImageHolder> productImgHolderList) throws ProductOperationException {
        ...
        if (product != null && product.getShop() != null && product.getShop().getShopId() != null) {
            //给商品设置上默认属性
            product.setLastEditTime(new Date());
            //若商品缩略图不为空且原有的缩略图不为空则删除原有的缩率图并添加
            if (thumbnail != null) {
                //获取一遍原来信息，因为原来的信息里有原图片的地址
