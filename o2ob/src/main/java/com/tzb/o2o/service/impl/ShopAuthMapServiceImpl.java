...
import com.tzb.o2o.dao.ShopAuthMapDao;
import com.tzb.o2o.dto.ShopAuthMapExecution;
import com.tzb.o2o.entity.ShopAuthMap;
import com.tzb.o2o.enums.ShopAuthMapStateEnum;
import com.tzb.o2o.exceptions.ShopAuthMapOperationException;
import com.tzb.o2o.service.ShopAuthMapService;
...
public class ShopAuthMapServiceImpl implements ShopAuthMapService {
    ...
    public ShopAuthMapExecution listShopAuthMapByShopId(Long shopId, Integer pageIndex, Integer pageSize) {
        ...
        if (shopId != null && pageIndex != null && pageSize != null) {
            // 页转行
            int beginIndex = PageCalculatorUtil.calculateRowIndex(pageIndex, pageSize);
            // 查询返回该店铺的授权信息列表
