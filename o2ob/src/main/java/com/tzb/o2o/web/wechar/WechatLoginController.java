package com.tzb.o2o.web.wechar;

import com.tzb.o2o.dto.UserAccessToken;
import com.tzb.o2o.dto.WechatAuthExecution;
import com.tzb.o2o.dto.WechatUser;
import com.tzb.o2o.entity.PersonInfo;
import com.tzb.o2o.entity.WechatAuth;
import com.tzb.o2o.enums.WechatAuthStateEnum;
import com.tzb.o2o.service.PersonInfoService;
import com.tzb.o2o.service.WechatAuthService;
import com.tzb.o2o.util.wechat.WechatUtil;
...
//        //获取微信公众号传输过来的code，通过code可获取access_token，进二获取用户信息
